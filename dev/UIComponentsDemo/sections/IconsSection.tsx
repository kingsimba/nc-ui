...
const iconGroups = [
    ...
    },
    {
        ...
        icons: [
            ...
            { name: 'CopyFilledIcon', Icon: CopyFilledIcon },
            ...
            { name: 'TrashFilledIcon', Icon: TrashFilledIcon },
        ],
    },
    {
        label: 'Actions',
    ...
    {
        label: 'People',
        icons: [{ name: 'UserIcon', Icon: UserIcon }],
    },
    {
        label: 'Devices & apps',
        icons: [
